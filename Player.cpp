...
void Player::AppendPlayerInfo(string & playersInfo) const
{
	...
	color playerColor = UI.PlayerColors[playerNum - 1];
	//playersInfo += "[Color: RGB(" + to_string(playerColor.ucRed) + ", " + to_string(playerColor.ucGreen) + ", " + to_string(playerColor.ucBlue) + ")]";
}